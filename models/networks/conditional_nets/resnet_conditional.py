...
class ResNetCondNetProg(nn.Module):
    ...
    def __init__(self, img_size, downsample_levels=3, cond_conv_channels=[64,64,128], use_fc_block=True,cond_fc_size=128):
        ...
        self.dsl = downsample_levels
        self.img_size = img_size
        self.unet_out_shape = 128 #Number of channels in the output of the UNet
        self.fc_cond_dim = cond_fc_size
        self.shapes = [self.unet_out_shape] + cond_conv_channels
        self.use_fc_block = use_fc_block
