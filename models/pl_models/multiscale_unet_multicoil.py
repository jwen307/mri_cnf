...
class MulticoilCNF(_BaseCFlow):
    ...
    def __init__(self, config):
        ...
        # Initialize the UNet
        # self.unet = UNetMulticoil(self.input_dims,
        #                       unetbuild,
        #                       config
        #                       )
    ...
    def get_MAP(self, c, mask=None, norm_val=None, epochs=5000):
        '''
        ...
        opt = torch.optim.Adam([ksub], lr=0.0000002)
    ...
    def reconstruct_MAPS(self, cond, maps=None, mask=None, norm_val=None,
                    rss=False, multicoil=False, epochs=500):
        '''
        cond: (b,c,h,w)
        ...
        for i in range(b):
            ...
            recon = self.get_MAP(cond[i].unsqueeze(0), mask=mask, norm_val=norm_val[i], epochs=epochs)
